...
#line 75 "/Users/lmccullu/openfast/unit_tests/../modules/beamdyn/tests/test_BD_diffmtc.F90"
  call assertEqual(baseline_shape, test_shape, tolerance, testname, &
 & location=SourceLocation( &
 & 'test_BD_diffmtc.F90', &
 & 75) )
  if (anyExceptions()) return
#line 76 "/Users/lmccullu/openfast/unit_tests/../modules/beamdyn/tests/test_BD_diffmtc.F90"
#line 76 "/Users/lmccullu/openfast/unit_tests/../modules/beamdyn/tests/test_BD_diffmtc.F90"
 ...
 & 76) )
  if (anyExceptions()) return
#line 77 "/Users/lmccullu/openfast/unit_tests/../modules/beamdyn/tests/test_BD_diffmtc.F90"
...
function test_BD_diffmtc_suite() result(suite)
   ...
   external test_BD_diffmtc


   suite = newTestSuite('test_BD_diffmtc_suite')

   call suite%addTest(newTestMethod('test_BD_diffmtc', test_BD_diffmtc))
