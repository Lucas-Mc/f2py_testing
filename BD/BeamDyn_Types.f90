...
! =========  BD_InitOutputType  =======
  TYPE, PUBLIC :: BD_InitOutputType
    ...
    ! CHARACTER(200) , DIMENSION(:), ALLOCATABLE  :: LinNames_y      !< Names of the outputs used in linearization [-]
    ! CHARACTER(200) , DIMENSION(:), ALLOCATABLE  :: LinNames_x      !< Names of the continuous states used in linearization [-]
    ! CHARACTER(200) , DIMENSION(:), ALLOCATABLE  :: LinNames_u      !< Names of the inputs used in linearization [-]
